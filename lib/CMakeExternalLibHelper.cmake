# CMakeExternalLibHelper.cmake
#
# a function to add a folder containing a c library compiling with make
...
function(add_external_library)
    ...
    add_custom_target(${ARGS_TARGET}_extrn DEPENDS ${ARGS_OUTPUT})

    # Create an library target out of the library compilation result
    add_library(${ARGS_TARGET} STATIC IMPORTED GLOBAL)
    add_dependencies(${ARGS_TARGET} ${ARGS_TARGET}_extrn)
